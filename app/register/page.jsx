...
export default function RegisterPage() {
  ...
  useEffect(() => {
    // Redirect to patient registration by default
          ...
          <div className="flex mb-8 border rounded-md overflow-hidden">
            <button
              className={`flex-1 py-3 text-center ${
                activeTab === "patient" ? "bg-white font-medium text-black" : "bg-gray-100 text-gray-600"
              }`}
            ...
            <button
              className={`flex-1 py-3 text-center ${
                activeTab === "doctor" ? "bg-white font-medium text-black" : "bg-gray-100 text-gray-600"
              }`}
